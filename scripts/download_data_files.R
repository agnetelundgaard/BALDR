...
download.file("https://ftp.uniprot.org/pub/databases/uniprot/knowledgebase/complete/docs/sec_ac.txt", destfile = str_c(data_dir, "UniProt_mapping_files/", "sec_ac.txt"))
...
# STRING database
string_data <- str_c(data_dir, "STRING/", "9606.protein.physical.links.detailed.v11.5.txt.gz")
